...
final class Acocam_Agent_Embed {
    ...
    public static function register_settings(): void {
        ...
        register_setting('acocam_agent_embed', 'acocam_agent_customer_token_key');
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td><input type="url" class="regular-text" name="acocam_agent_api_base" value="<?php echo esc_attr(get_option('acocam_agent_api_base', 'https://chat-api.acocamtrading.ca/v1')); ?>" placeholder="https://chat-api.acocamtrading.ca/v1" /></td>
                    ...
                    <tr>
                        ...
                        <td><input type="url" class="regular-text" name="acocam_agent_embed_script" value="<?php echo esc_attr(get_option('acocam_agent_embed_script', 'https://chat-api.acocamtrading.ca/embed/agent-embed.js')); ?>" /></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="regular-text" name="acocam_agent_publishable_key" value="<?php echo esc_attr(get_option('acocam_agent_publishable_key', '')); ?>" placeholder="pk_live_..." /></td>

                    </tr>

                    <tr>

                        <th>Customer JWT storage key</th>

                        <td>

                            <input type="text" class="regular-text" name="acocam_agent_customer_token_key" value="<?php echo esc_attr(get_option('acocam_agent_customer_token_key', 'token')); ?>" placeholder="token" />

                            <p class="description">localStorage key after login on acocamtrading.ca (enables Book shipment for logged-in users).</p>
    ...
    public static function print_embed(): void {
        ...
        $tokenKey = get_option('acocam_agent_customer_token_key', 'token');
        ...
        $attrs = sprintf(
            ...
            'src="%s" data-tenant="%s" data-agent="%s" data-key="%s" data-api="%s"',
        ...
        if ($tokenKey) {
            ...
            $attrs .= sprintf(' data-customer-token-key="%s"', esc_attr($tokenKey));
